...
IF "%action_choice%"=="2" goto:display_credits
IF "%action_choice%"=="3" goto:check_update
IF "%action_choice%"=="4" goto:full_update
IF "%action_choice%"=="5" goto:donate
IF "%action_choice%"=="6" (
	start https://tooomm.github.io/github-release-stats/?username=shadow2560^&repository=Autopublish
...
del /q "%project_name%.bat.version" >nul
